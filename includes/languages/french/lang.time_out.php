...
$define = [
    ...
    'TEXT_INFORMATION' => '<p>Si vous êtiez en train de passer commande, veuillez vous connecter et votre panier sera restauré. Vous pourrez alors revenir à l\'encaissement et terminer votre achat final.</p><p>Si vous aviez terminé une commande et vous souhaitez la contôler'.(DOWNLOAD_ENABLED'true'?', ou si vous aviez un téléchargement et souhaitez le reprendre':'',
