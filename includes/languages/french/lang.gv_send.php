...
$define = [
    ...
    'HEADING_TEXT' => 'Veuillez entrer le nom, adresse e-mail et montant du '.TEXT_GV_NAME.' que vous souhaitez envoyer. Pour de plus amples informations, veuillez consulter notre <a href="'.zen_href_link(FILENAME_GV_FAQ,'','NONSSL',
    'ENTRY_NAME' => 'Nom du destinataire: ',
    'ENTRY_EMAIL' => 'Adresse e-mail du destinataire: ',
    ...
    'MAIN_MESSAGE' => 'Vous envoyez un '.TEXT_GV_NAME.' d\'une valeur de %s à %s dont l\'adresse e-mail est %s. Si ces détails sont incorrects, vous pouvez modifier votre message en cliquant sur le bouton <strong>edit</strong>.<br /><br />Le message que vous envoyez est le suivant:<br /><br />',
    'SECONDARY_MESSAGE' => 'Cher(Chère) %s,<br /><br />'.'Un '.TEXT_GV_NAME.' d\'une valeur de %s vous a été envoyé par %s',
    ...
    'TEXT_AVAILABLE_BALANCE' => 'Solde de chèque cadeau: ',
