...
$define = [
    ...
    'HEADING_TITLE_MODULES_ORDER_TOTAL' => 'Modules de Total Commande',
    'TABLE_HEADING_MODULES' => 'Modules',
    'TABLE_HEADING_SORT_ORDER' => 'Trier les commandes ',
    'TABLE_HEADING_ORDERS_STATUS' => 'Statut des commandes',
    'TABLE_HEADING_ACTION' => 'Action',
    'TEXT_MODULE_DIRECTORY' => 'Répertoire du module:',
    'ERROR_MODULE_FILE_NOT_FOUND' => 'ERREUR : Module non chargé à cause de fichier de langue manquant : ',
    'TEXT_EMAIL_SUBJECT_ADMIN_SETTINGS_CHANGED' => 'ALERTE : Vos paramètres Admin ont été changés dans votre boutique en ligne.',
    'TEXT_EMAIL_MESSAGE_ADMIN_SETTINGS_CHANGED' => 'Ceci est un mail automatique envoyé par votre boutique Zen Cart pour vous alerter qu\'un changement vient d\'être effectué dans vos paramètres administratifs : '."\n\n".'NOTE : Les paramètres Admin ont été MODIFIÉS pour le module [%s], par l\'utilisateur de l\'administration %s.'."\n\n".'Si vous n\'êtes pas à l\'origine de ces modifications, il est judiceux que vous vérifiez immédiatemment les paramètres.'."\n\n".'Si vous êtes déjà au courant de ces changements, vous pouvez ignorer cet e-mail automatique.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_INSTALLED' => 'Ceci est un mail automatique envoyé par votre boutique Zen Cart pour vous alerter qu\'un changement vient d\'être effectué dans vos paramètres administratifs : '."\n\n".'NOTE : Les paramètres Admin ont été modifiés. Le module [%s] a été INSTALLÉ par l\'utilisateur de l\'administration %s.'."\n\n".'Si vous n\'êtes pas à l\'origine de ces modifications, il est judiceux que vous vérifiez immédiatemment les paramètres.'."\n\n".'Si vous êtes déjà au courant de ces changements, vous pouvez ignorer cet e-mail automatique.',
    'TEXT_EMAIL_MESSAGE_ADMIN_MODULE_REMOVED' => 'Ceci est un mail automatique envoyé par votre boutique Zen Cart pour vous alerter qu\'un changement vient d\'être effectué dans vos paramètres administratifs : '."\n\n".'NOTE : Les paramètres Admin ont été modifiés. Le module [%s] a été ENLEVÉ par l\'utilisateur de l\'administration %s.'."\n\n".'Si vous n\'êtes pas à l\'origine de ces modifications, il est judiceux que vous vérifiez immédiatemment les paramètres.'."\n\n".'Si vous êtes déjà au courant de ces changements, vous pouvez ignorer cet e-mail automatique.',
