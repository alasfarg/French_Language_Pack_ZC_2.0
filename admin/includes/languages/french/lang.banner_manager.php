...
$define = [
    ...
    'TEXT_BANNERS_IMAGE_LOCAL' => ', ou indiquez un fichier local (côté serveur) ci-dessous ',
    'TEXT_BANNERS_IMAGE_TARGET' => 'Image cible [Enregistrer sous] :',
    'TEXT_BANNER_IMAGE_TARGET_INFO' => '<strong>Répertoire cible proposé pour l\'image sur le serveur :</strong> '.DIR_FS_CATALOG_IMAGES.'banners/',
    'TEXT_BANNERS_HTML_TEXT_INFO' => '<strong>NOTE : Les bannières HTML n\'enregistrent pas les clics dessus</strong>',
    ...
    'TEXT_BANNERS_EXPIRY_NOTE' => '<b>Notes sur la date d\'expiration :</b><ul><li>Seul un des deux champs devrait être renseigné</li><li>Si vous ne désirez pas faire figurer de date d\'expiration automatique de la bannière, laissez ces deux champs vides</li></ul>',
    ...
    'ERROR_UNKNOWN_BANNER_OPEN_NEW_WINDOW' => 'Erreur: Impossible de configurer la bannière pour qu\'elle s\'ouvre dans une nouvelle fenêtre',
    'ERROR_UNKNOWN_BANNER_ON_SSL' => 'Error: La bannière n\'a pas pu être configurée pour utiliser SSL',
    'ERROR_INVALID_SCHEDULED_DATE' => 'L\'option « Planifié à » la date n\'est pas valide, veuillez la saisir à nouveau.',
    'ERROR_INVALID_EXPIRES_DATE' => 'Le champ « Expire le » la date n\'est pas valide, veuillez saisir à nouveau.',
