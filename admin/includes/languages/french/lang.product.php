...
$define = [
    ...
    'TEXT_PRODUCTS_PRICE_NET' => 'Prix (HT) :',
    'TEXT_PRODUCTS_PRICE_GROSS' => 'Prix (TTC) :',
    'TEXT_SHIPPING_PACKAGE_DETAILS' => 'Détails d\'expédition du colis',
    'TEXT_PRODUCTS_WEIGHT' => 'Poids à l\'expédition des produits :',
    'TEXT_PRODUCTS_LENGTH' => 'Longeur:',
    'TEXT_PRODUCTS_WIDTH' => 'Largeur:',
    'TEXT_PRODUCTS_HEIGHT' => 'Hauteur:'
    'TEXT_PRODUCT_SHIPS_IN_OWN_BOX' => 'Expédié dans sa propre boîte?',
    'TEXT_PRODUCT_SHIPS_IN_OWN_BOX_HELP' => 'L\'article est expédié dans sa boîte d\'origine ? (c\'est-à-dire : ne sera pas combiné dans une autre boîte pour l\'expédition, et aucun frais d\'emballage supplémentaire à ajouter)',
    'TEXT_PRODUCT_SHIPS_IN_OWN_BOX' => 'Expédié dans sa propre boîte?',
    'TEXT_PRODUCT_SHIPS_IN_OWN_BOX_HELP' => 'L\'article est expédié dans sa boîte d'origine ? (c'est-à-dire : ne sera pas combiné dans une autre boîte pour l\'expédition, et aucun frais d\'emballage supplémentaire à ajouter)',
    ...
    'TEXT_PRODUCTS_IS_CALL_PREVIEW' => '*Le produit est marqué comme APPEL POUR PRIX',
    'TEXT_PRODUCTS_IS_CALL_EDIT' => '*Le produit est marqué comme APPEL POUR PRIX',
