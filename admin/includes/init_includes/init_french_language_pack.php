 ...
 * @version 2.0.0
 * @author Zen4All with minor adaptions for the French version for Zen Cart 2.0.0 by André Lasfargues
 ...
 */
 ...
 $module_constant = 'FRENCH_LANGUAGE_PACK_VERSION';
 $module_installer_directory = DIR_FS_ADMIN . 'includes/installers/french_language_pack';
 $module_name = 'French Language Pack';
 $module_file_for_version_check = '';
 $zencart_com_plugin_id = 2310;
